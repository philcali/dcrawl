...
const EQUIPMENT_TEMPLATES = {
  // === WEAPONS (13 items) ===
  rusted_dagger:    { name: 'Rusted Dagger',    slot: 'weapon',     rarity: 'common',   primaryStat: 'atk', primaryValue: 3,  statBonuses: { atk: 3 },  skillGrant: null },
  short_sword:      { name: 'Short Sword',      slot: 'weapon',     rarity: 'common',   primaryStat: 'atk', primaryValue: 5,  statBonuses: { atk: 5 },  skillGrant: null },
  iron_mace:        { name: 'Iron Mace',        slot: 'weapon',     rarity: 'common',   primaryStat: 'atk', primaryValue: 7,  statBonuses: { atk: 7 },  skillGrant: null },
  bronze_blade:     { name: 'Bronze Blade',     slot: 'weapon',     rarity: 'uncommon', primaryStat: 'atk', primaryValue: 8,  statBonuses: { atk: 8 },  skillGrant: null },
  battle_axe:       { name: 'Battle Axe',       slot: 'weapon',     rarity: 'uncommon', primaryStat: 'atk', primaryValue: 10, statBonuses: { atk: 10 }, skillGrant: null },
  war_hammer:       { name: 'War Hammer',       slot: 'weapon',     rarity: 'uncommon', primaryStat: 'atk', primaryValue: 12, statBonuses: { atk: 12 }, skillGrant: null },
  long_sword:       { name: 'Long Sword',       slot: 'weapon',     rarity: 'rare',     primaryStat: 'atk', primaryValue: 14, statBonuses: { atk: 14 }, skillGrant: 'whirlwind' },
  flame_sword:      { name: 'Flame Sword',      slot: 'weapon',     rarity: 'rare',     primaryStat: 'atk', primaryValue: 15, statBonuses: { atk: 15 }, skillGrant: 'whirlwind' },
  frost_blade:      { name: 'Frost Blade',      slot: 'weapon',     rarity: 'rare',     primaryStat: 'atk', primaryValue: 17, statBonuses: { atk: 17 }, skillGrant: 'whirlwind' },
  void_edge:        { name: 'Void Edge',        slot: 'weapon',     rarity: 'rare',     primaryStat: 'atk', primaryValue: 19, statBonuses: { atk: 19 }, skillGrant: 'whirlwind' },
  shadow_blade:     { name: 'Shadow Blade',     slot: 'weapon',     rarity: 'epic',     primaryStat: 'atk', primaryValue: 22, statBonuses: { atk: 22 }, skillGrant: 'counter_strike' },
  storm_edge:       { name: 'Storm Edge',       slot: 'weapon',     rarity: 'epic',     primaryStat: 'atk', primaryValue: 26, statBonuses: { atk: 26 }, skillGrant: 'counter_strike' },
  sun_pearl:        { name: 'Sun Pearl',        slot: 'weapon',     rarity: 'epic',     primaryStat: 'atk', primaryValue: 30, statBonuses: { atk: 30 }, skillGrant: 'counter_strike' },
  // === OFFHANDS (11 items) ===
  ...
  buckler:          { name: 'Buckler',          slot: 'offhand',  rarity: 'common',   primaryStat: 'def', primaryValue: 5,  statBonuses: { def: 5 },  skillGrant: null },
  reinforced_shield: { name: 'Reinforced Shield', slot: 'offhand', rarity: 'common',   primaryStat: 'def', primaryValue: 7,  statBonuses: { def: 7, maxHp: 2 }, skillGrant: null },
  ...
  tower_shield:     { name: 'Tower Shield',     slot: 'offhand',  rarity: 'uncommon', primaryStat: 'def', primaryValue: 9,  statBonuses: { def: 9 },  skillGrant: null },
  kite_shield:      { name: 'Kite Shield',      slot: 'offhand',  rarity: 'uncommon', primaryStat: 'def', primaryValue: 12, statBonuses: { def: 12, maxHp: 3 }, skillGrant: null },
  magic_shield:     { name: 'Magic Shield',     slot: 'offhand',  rarity: 'rare',     primaryStat: 'def', primaryValue: 11, statBonuses: { def: 11 }, skillGrant: 'barrier' },
  guardian_shield:  { name: 'Guardian Shield',  slot: 'offhand',  rarity: 'rare',     primaryStat: 'def', primaryValue: 14, statBonuses: { def: 14, maxHp: 5 }, skillGrant: 'barrier' },
  aegis_shield:     { name: 'Aegis Shield',     slot: 'offhand',  rarity: 'rare',     primaryStat: 'def', primaryValue: 17, statBonuses: { def: 17, maxHp: 8 }, skillGrant: 'barrier' },
  celestial_shield: { name: 'Celestial Shield', slot: 'offhand',  rarity: 'epic',     primaryStat: 'def', primaryValue: 22, statBonuses: { def: 22, maxHp: 10 }, skillGrant: 'phase' },
  holy_barrier:     { name: 'Holy Barrier',     slot: 'offhand',  rarity: 'epic',     primaryStat: 'def', primaryValue: 26, statBonuses: { def: 26, maxHp: 14 }, skillGrant: 'phase' },
  // === HEADS (11 items) ===
  ...
  iron_cap:         { name: 'Iron Cap',         slot: 'head',     rarity: 'common',   primaryStat: 'maxHp', primaryValue: 4, statBonuses: { maxHp: 4, def: 1 }, skillGrant: null },
  reinforced_helm:  { name: 'Reinforced Helm',  slot: 'head',     rarity: 'common',   primaryStat: 'maxHp', primaryValue: 6, statBonuses: { maxHp: 6, def: 2 }, skillGrant: null },
  ...
  knight_helm:      { name: 'Knight Helm',      slot: 'head',     rarity: 'uncommon', primaryStat: 'maxHp', primaryValue: 8, statBonuses: { maxHp: 8, def: 4 }, skillGrant: null },
  great_helm:       { name: 'Great Helm',       slot: 'head',     rarity: 'uncommon', primaryStat: 'maxHp', primaryValue: 11, statBonuses: { maxHp: 11, def: 5 }, skillGrant: null },
  ...
  paladin_circlet:  { name: 'Paladin Circlet',  slot: 'head',     rarity: 'rare',     primaryStat: 'maxHp', primaryValue: 11, statBonuses: { maxHp: 11, def: 3 }, skillGrant: 'arcane_blast' },
  warlord_helm:     { name: 'Warlord Helm',     slot: 'head',     rarity: 'rare',     primaryStat: 'maxHp', primaryValue: 14, statBonuses: { maxHp: 14, def: 6 }, skillGrant: 'arcane_blast' },
  mythril_crown:    { name: 'Mythril Crown',    slot: 'head',     rarity: 'epic',     primaryStat: 'maxHp', primaryValue: 16, statBonuses: { maxHp: 16, def: 5, atk: 3 }, skillGrant: 'arcane_blast' },
  oracle_diadem:    { name: 'Oracle Diadem',    slot: 'head',     rarity: 'epic',     primaryStat: 'maxHp', primaryValue: 22, statBonuses: { maxHp: 22, def: 6, atk: 5 }, skillGrant: 'arcane_blast' },
  // === BODIES (11 items) ===
  ...
  padded_gambeson:  { name: 'Padded Gambeson',  slot: 'body',     rarity: 'common',   primaryStat: 'def', primaryValue: 5,  statBonuses: { def: 5, maxHp: 4 }, skillGrant: null },
  reinforced_vest:  { name: 'Reinforced Vest',  slot: 'body',     rarity: 'common',   primaryStat: 'def', primaryValue: 7,  statBonuses: { def: 7, maxHp: 6 }, skillGrant: null },
  ...
  splint_mail:      { name: 'Splint Mail',      slot: 'body',     rarity: 'uncommon', primaryStat: 'def', primaryValue: 8,  statBonuses: { def: 8, maxHp: 5 }, skillGrant: null },
  full_plate:       { name: 'Full Plate',       slot: 'body',     rarity: 'uncommon', primaryStat: 'def', primaryValue: 11, statBonuses: { def: 11, maxHp: 8 }, skillGrant: null },
  plate_armor:      { name: 'Plate Armor',      slot: 'body',     rarity: 'rare',     primaryStat: 'def', primaryValue: 11, statBonuses: { def: 11, maxHp: 8 }, skillGrant: null },
  holy_armor:       { name: 'Holy Armor',       slot: 'body',     rarity: 'rare',     primaryStat: 'def', primaryValue: 14, statBonuses: { def: 14, maxHp: 12 }, skillGrant: 'barrier' },
  drakescale_mail:  { name: 'Drakescale Mail',  slot: 'body',     rarity: 'rare',     primaryStat: 'def', primaryValue: 17, statBonuses: { def: 17, maxHp: 15 }, skillGrant: 'barrier' },
  shadow_cloak:     { name: 'Shadow Cloak',     slot: 'body',     rarity: 'epic',     primaryStat: 'def', primaryValue: 18, statBonuses: { def: 18, maxHp: 8 }, skillGrant: 'phase' },
  abyssal_plate:    { name: 'Abyssal Plate',    slot: 'body',     rarity: 'epic',     primaryStat: 'def', primaryValue: 24, statBonuses: { def: 24, maxHp: 14 }, skillGrant: 'phase' },
};
